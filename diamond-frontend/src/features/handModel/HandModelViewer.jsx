...
const RING_POSITIONING = {
  ...
  cx_ratio: 0.37,     // 52% of hand width (moved MORE LEFT - was 0.58)
  cy_ratio: 0.40,     // 46% of hand height (middle of ring finger)
  
  // Base scale: MUCH SMALLER to fit properly on finger
  baseScale: 0.23,    // Small ring size for finger fit
  scalePerCarat: 0.05, // minimal scaling between carats
  
  // Offset from finger center
  offsetX: 6,         // Minimal offset (was 15)
  offsetY: -8,        // Position UP on finger
